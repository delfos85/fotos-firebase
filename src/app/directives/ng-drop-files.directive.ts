...
export class NgDropFilesDirective {
  ...
  console.log(`ver que tipo de archivo es ${archivo.type}`);
  ...
  private _esImagen( tipoArchivo: string ): boolean {
    return ( tipoArchivo === '' || tipoArchivo === undefined ) ? false : tipoArchivo.startsWith('image') || tipoArchivo.endsWith('pdf');
  }
  private _esPDF( tipoArchivo: string ): boolean {
    console.log(tipoArchivo);
    console.log(tipoArchivo.endsWith('pdf'));
